...
from opd import Object, items, keys, register, update, values
from opd import load, kind, save, edit, dumps, loads, printable
from opd import Wd
...
class TestObject(unittest.TestCase):
    ...
    def test_kind(self):
        self.assertEqual(kind(Object()), "opd.obj.Object")
